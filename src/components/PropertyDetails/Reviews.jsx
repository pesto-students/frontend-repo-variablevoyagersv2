...
const Reviews = () => {
  return (
    <div className="flex justify-between gap-5 items-center">
      <div className="flex flex-col md:w-[50%] w-[100%] items-center gap-2 shadow-md shadow-slate-300 border p-4">
        {/*          <!-- Title --> */}
      ...
      <div className="hidden md:flex  flex-col w-[50%] gap-9  shadow-md shadow-slate-300 border p-4">
        {/*          <!-- Category rating --> */}
        <div className="flex items-center gap-6">
          {/*            <!-- Title --> */}
          <h4 className="flex-1 text-sm font-medium text-slate-700">Service</h4>
          {/*            <!-- Rating --> */}
          <span className="flex items-center gap-4 rounded text-sm text-slate-500">
            <span
        ...
        <div className="flex items-center gap-6">
          {/*            <!-- Title --> */}
          <h4 className="flex-1 text-sm font-medium text-slate-700">Price</h4>
          {/*            <!-- Rating --> */}
          <span className="flex items-center gap-4 rounded text-sm text-slate-500">
            <span
              className="flex text-amber-400"
        ...
        <div className="flex items-center gap-6">
          {/*            <!-- Title --> */}
          <h4 className="flex-1 text-sm font-medium text-slate-700">Quality</h4>
          {/*            <!-- Rating --> */}
          <span className="flex items-center gap-4 rounded text-sm text-slate-500">
            <span
              className="flex text-amber-400"
        ...
        <div className="flex items-center gap-6">
          {/*            <!-- Title --> */}
          <h4 className="flex-1 text-sm font-medium text-slate-700">
            Availability
          </h4>
          {/*            <!-- Rating --> */}
          <span className="flex items-center gap-4 rounded text-sm text-slate-500">
