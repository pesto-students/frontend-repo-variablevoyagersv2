        ...
        <div className="col-span-4 flex flex-col gap-8">
            <div className="flex flex-col gap-5">
                <div className='flex flex-row'>
                    {tags?.map((tag, index) =>
                        <span key={index} className="w-fit bg-primary text-white text-xs me-2 px-2.5 py-1.5 rounded-full">{tag}</span>
                    )}
                </div>
                {/* {console.log(tags)} */}
                <div>
                    ...
                    <div className="flex flex-row items-center gap-4 text-md text-neutral-600">
